...
interface PaymentDocumentsDashboardProps {
  dashboardData: ModuleDashboardData;
}

const PaymentDocumentsDashboard: React.FC<PaymentDocumentsDashboardProps> = ({ dashboardData }) => {
...
export default PaymentDocumentsDashboard;
