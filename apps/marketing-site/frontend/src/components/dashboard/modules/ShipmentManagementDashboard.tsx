...
interface ShipmentManagementDashboardProps {
  dashboardData: ModuleDashboardData;
}

const ShipmentManagementDashboard: React.FC<ShipmentManagementDashboardProps> = ({ dashboardData }) => {
...
export default ShipmentManagementDashboard;
