...
class ExportProcess(Base):
    ...
    payments = relationship("Payment", back_populates="export_process")
    containers = relationship("Container", back_populates="export_process")
    tracking_events = relationship("TrackingEvent", back_populates="export_process")
    compliance_checks = relationship("ComplianceCheck", back_populates="export_process")
    comments = relationship("Comment", back_populates="export_process")
    drawback_acts = relationship("DrawbackAct", back_populates="export_process")
    product_rel = relationship("Product", foreign_keys=[product_id], overlaps="product")
    inventory_items = relationship("InventoryItem", back_populates="export_process")
    stock_movements = relationship("StockMovement", back_populates="export_process")
    tasks = relationship("Task", back_populates="export_process") 