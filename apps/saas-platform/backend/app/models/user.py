...
class User(Base):
    ...
    comments = relationship("Comment", foreign_keys="Comment.created_by", back_populates="created_by_user")
    ...
    dashboard_config = relationship("UserDashboardConfig", back_populates="user", uselist=False)
